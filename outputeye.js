...
//         console.log(gamepadAPI.axesStatus[1]*gamepadAPI.axesStatus[0]) //debugging
    ...
    function main() {
        ...
        //             if(t!=k){
        //                     orbs[t].xmom-=(orbs[t].x-orbs[k].x)*.0001
        //                     orbs[t].ymom-=(orbs[t].y-orbs[k].y)*.0001
        //             }
        ...
        //         for(let k = 0;k<orbs.length;k++){
        //             if(t!=k){
        //                 if(orbs[t].doesPerimeterTouch(orbs[k])){
        //                     let link = new LineOP(orbs[t], orbs[k])
        //                     orbs[t].xmom+=((link.hypotenuse()-10)*Math.cos(link.angle()))
        //                     orbs[t].ymom+=((link.hypotenuse()-10)*Math.sin(link.angle()))
        //                     orbs[k].xmom-=((link.hypotenuse()-10)*Math.cos(link.angle()))
        //                     orbs[k].ymom-=((link.hypotenuse()-10)*Math.sin(link.angle()))
        //                 }
        //             }
...
for(let t = 0;t<Math.floor(sumtotal/25);t++){
    boxes[t].draw((t*20)%3050,Math.floor(t)%2400)
}
    }
